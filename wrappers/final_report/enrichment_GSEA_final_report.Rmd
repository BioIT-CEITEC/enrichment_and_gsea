...
if(config_json$onthology[1]==TRUE){
  ...
  BP.files <- BP.files[, plotpath := gsub(".tsv",".svg",plotpath)]
...
if(config_json$onthology[1]==TRUE){
  ...
  BPg.files <- BPg.files[, plotpath := gsub(".tsv", ".svg", plotpath)]
...
if(config_json$onthology[1]==TRUE){
  ...
  MF.files <- MF.files[, plotpath := gsub(".tsv",".svg",plotpath)]
...
if(config_json$onthology[1]==TRUE){
  ...
  MFg.files <- MFg.files[, plotpath := gsub(".tsv", ".svg", plotpath)]
...
if(config_json$onthology[1]==TRUE){
  ...
  CC.files <- CC.files[, plotpath := gsub(".tsv",".svg",plotpath)]
...
if(config_json$onthology[1]==TRUE){
  ...
  CCg.files <- CCg.files[, plotpath := gsub(".tsv", ".svg", plotpath)]
...
if(config_json$kegg[1]==TRUE){
  ...
  ke.files <- ke.files[, plotpath := gsub(".tsv", ".svg", plotpath)]
...
if(config_json$kegg[1]==TRUE){
  ...
  keg.files <- keg.files[, plotpath := gsub(".tsv", ".svg", plotpath)]
...
if(config_json$reactome[1]==TRUE){
  ...
  re.files <- re.files[, plotpath := gsub(".tsv", ".svg", plotpath)]
...
if(config_json$reactome[1]==TRUE){
  ...
  reg.files <- reg.files[, plotpath := gsub(".tsv", ".svg", plotpath)]
...
if(config_json$wikipathways[1]==TRUE){
  ...
  wp.files <- wp.files[, plotpath := gsub(".tsv", ".svg", plotpath)]
...
if(config_json$wikipathways[1]==TRUE){
  ...
  wpg.files <- wpg.files[, plotpath := gsub(".tsv", ".svg", plotpath)]
