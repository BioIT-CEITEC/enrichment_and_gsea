...
DE <- NULL
if(config_json$feature_count[1]==T){DE <- c(DE, "DE_feature_count")}
...
if(config_json$onthology[1]==TRUE){
  BP.files <- data.table(plotpath = list.files(path=paste0(DE,"/",comparison,"/",biotype,"/enrichment_GO"), pattern = "BP.svg", full.names = TRUE), tablpath = list.files(path=paste0(DE,"/",comparison,"/",biotype,"/enrichment_GO"), pattern = "BP.tsv", full.names = TRUE))
  BP.files <- BP.files[, `:=` (de = unlist(strsplit(plotpath, "/"))[1], comp = unlist(strsplit(plotpath, "/"))[2]), by = .(plotpath)]
...
if(config_json$onthology[1]==TRUE){
  BPg.files <- data.table(plotpath = list.files(path=paste0(DE,"/",comparison,"/",biotype,"/GSEA_GO"), pattern = "BP.svg", full.names = TRUE), tablpath = list.files(path=paste0(DE,"/",comparison,"/",biotype,"/GSEA_GO"), pattern = "BP.tsv", full.names = TRUE))
  BPg.files <- BPg.files[, `:=` (de = unlist(strsplit(plotpath, "/"))[1], comp = unlist(strsplit(plotpath, "/"))[2]), by = .(plotpath)]
...
if(config_json$onthology[1]==TRUE){
  MF.files <- data.table(plotpath = list.files(path=paste0(DE,"/",comparison,"/",biotype,"/enrichment_GO"), pattern = "MF.svg", full.names = TRUE), tablpath = list.files(path=paste0(DE,"/",comparison,"/",biotype,"/enrichment_GO"), pattern = "MF.tsv", full.names = TRUE))
  MF.files <- MF.files[, `:=` (de = unlist(strsplit(plotpath, "/"))[1], comp = unlist(strsplit(plotpath, "/"))[2]), by = .(plotpath)]
...
if(config_json$onthology[1]==TRUE){
  MFg.files <- data.table(plotpath = list.files(path=paste0(DE,"/",comparison,"/",biotype,"/GSEA_GO"), pattern = "MF.svg", full.names = TRUE), tablpath = list.files(path=paste0(DE,"/",comparison,"/",biotype,"/GSEA_GO"), pattern = "MF.tsv", full.names = TRUE))
  MFg.files <- MFg.files[, `:=` (de = unlist(strsplit(plotpath, "/"))[1], comp = unlist(strsplit(plotpath, "/"))[2]), by = .(plotpath)]
...
if(config_json$onthology[1]==TRUE){
  CC.files <- data.table(plotpath = list.files(path=paste0(DE,"/",comparison,"/",biotype,"/enrichment_GO"), pattern = "CC.svg", full.names = TRUE), tablpath = list.files(path=paste0(DE,"/",comparison,"/",biotype,"/enrichment_GO"), pattern = "CC.tsv", full.names = TRUE))
  CC.files <- CC.files[, `:=` (de = unlist(strsplit(plotpath, "/"))[1], comp = unlist(strsplit(plotpath, "/"))[2]), by = .(plotpath)]
...
if(config_json$onthology[1]==TRUE){
  CCg.files <- data.table(plotpath = list.files(path=paste0(DE,"/",comparison,"/",biotype,"/GSEA_GO"), pattern = "CC.svg", full.names = TRUE), tablpath = list.files(path=paste0(DE,"/",comparison,"/",biotype,"/GSEA_GO"), pattern = "CC.tsv", full.names = TRUE))
  CCg.files <- CCg.files[, `:=` (de = unlist(strsplit(plotpath, "/"))[1], comp = unlist(strsplit(plotpath, "/"))[2]), by = .(plotpath)]
...
if(config_json$kegg[1]==TRUE){
  ke.files <- data.table(plotpath = list.files(path=paste0(DE,"/",comparison,"/",biotype,"/enrichment_KEGG"), pattern = "enrich.svg", full.names = TRUE), tablpath = list.files(path=paste0(DE,"/",comparison,"/",biotype,"/enrichment_KEGG"), pattern = "enrich.tsv", full.names = TRUE))
  ke.files <- ke.files[, `:=` (de = unlist(strsplit(plotpath, "/"))[1], comp = unlist(strsplit(plotpath, "/"))[2]), by = .(plotpath)]
...
if(config_json$kegg[1]==TRUE){
  keg.files <- data.table(plotpath = list.files(path=paste0(DE,"/",comparison,"/",biotype,"/GSEA_KEGG"), pattern = "KEGG.svg", full.names = TRUE), tablpath = list.files(path=paste0(DE,"/",comparison,"/",biotype,"/GSEA_KEGG"), pattern = "KEGG.tsv", full.names = TRUE))
  keg.files <- keg.files[, `:=` (de = unlist(strsplit(plotpath, "/"))[1], comp = unlist(strsplit(plotpath, "/"))[2]), by = .(plotpath)]
...
if(config_json$reactome[1]==TRUE){
  re.files <- data.table(plotpath = list.files(path=paste0(DE,"/",comparison,"/",biotype,"/enrichment_REACTOME"), pattern = "enrich.svg", full.names = TRUE), tablpath = list.files(path=paste0(DE,"/",comparison,"/",biotype,"/enrichment_REACTOME"), pattern = "enrich.tsv", full.names = TRUE))
  re.files <- re.files[, `:=` (de = unlist(strsplit(plotpath, "/"))[1], comp = unlist(strsplit(plotpath, "/"))[2]), by = .(plotpath)]
...
if(config_json$reactome[1]==TRUE){
  reg.files <- data.table(plotpath = list.files(path=paste0(DE,"/",comparison,"/",biotype,"/GSEA_REACTOME"), pattern = "REACTOME.svg", full.names = TRUE), tablpath = list.files(path=paste0(DE,"/",comparison,"/",biotype,"/GSEA_REACTOME"), pattern = "REACTOME.tsv", full.names = TRUE))
  reg.files <- reg.files[, `:=` (de = unlist(strsplit(plotpath, "/"))[1], comp = unlist(strsplit(plotpath, "/"))[2]), by = .(plotpath)]
...
if(config_json$wikipathways[1]==TRUE){
  wp.files <- data.table(plotpath = list.files(path=paste0(DE,"/",comparison,"/",biotype,"/enrichment_WP"), pattern = "enrich.svg", full.names = TRUE), tablpath = list.files(path=paste0(DE,"/",comparison,"/",biotype,"/enrichment_WP"), pattern = "enrich.tsv", full.names = TRUE))
  wp.files <- wp.files[, `:=` (de = unlist(strsplit(plotpath, "/"))[1], comp = unlist(strsplit(plotpath, "/"))[2]), by = .(plotpath)]
...
if(config_json$wikipathways[1]==TRUE){
  wpg.files <- data.table(plotpath = list.files(path=paste0(DE,"/",comparison,"/",biotype,"/GSEA_WP"), pattern = "WP.svg", full.names = TRUE), tablpath = list.files(path=paste0(DE,"/",comparison,"/",biotype,"/GSEA_WP"), pattern = "WP.tsv", full.names = TRUE))
  wpg.files <- wpg.files[, `:=` (de = unlist(strsplit(plotpath, "/"))[1], comp = unlist(strsplit(plotpath, "/"))[2]), by = .(plotpath)]
...
The result folders are organized as "Analysis/Comparison/Biotype/*" and contain the following folders and files:
